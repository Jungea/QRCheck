...
public class CommonController {
	...
	public String login(Model model, @RequestParam("num") String num, @RequestParam("pass") String pass,
...
//		} else 
		if (professorRepository.findByProfNumAndPassword(num, pass) != null) {
			System.out.println("교수");
			session.setAttribute("userNum", num);
			return "redirect:professor/list";
		} else if (studentRepository.findByStuNumAndPassword(num, pass) != null) {
			System.out.println("학생");
			model.addAttribute("message", "[ 학생은 출석 체크 어플을 이용해주시기 바랍니다. ]");
			return "login";
		} else {
